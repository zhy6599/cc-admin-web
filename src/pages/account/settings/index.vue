            ...
            <q-tab-panel name="basicSettings" class="row q-pt-sm">
              ...
              >
                ...
                <q-input
                  ...
                  square
                  label="个人简介"
                  v-model="basicSetting.personDesc"
                />
                <q-select
                  outlined
                  dense
                ...
                <span class="row q-gutter-x-sm">
                  <q-select
                    ...
                    options-dense
                    :options="['+86', '+87']"
                    v-model="basicSetting.phonePrefix"
                  />
                  <q-input
                    class="col"
                    outlined
...
export default {
  ...
  data() {
    return {
      basicSetting: {
        email: 'element@alipay.com',
        nickName: '游客',
        personDesc: '周游世界，博览全球！',
        country: '中国',
        province: '北京',
        city: '北京市',
        address: '东城区东四十条东厂天字一号',
        phonePrefix: '+86',
        phone: '13888888888',
      },
      safeData: {
        ...
        slaveEmail: '943***86@qq.com',
        mfaEquipment: null,
      },
      accountBindData: {
        bindTaoBaoNo: '123442',
        bindZfbNo: '13888888888',
        bindWechatNo: '12344',
      },
      newMsgData: {
        passwordMsg: true,
