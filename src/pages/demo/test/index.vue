      ...
      >
        <template v-slot:top="table">
          <div class="row no-wrap full-width">
            ...
            <q-space />
            <q-btn-group outline>
              <q-btn outline icon="add" no-wrap color="primary" label="新建测试代码生成" @click="add" />
              <q-btn
                outline
                color="primary"
                label="切换全屏"
        ...
        <template #body-cell-opt="props">
          <q-td :props="props" :auto-width="true">
            ...
            <btn-del label="测试代码生成" @confirm="del(props.row)" />
          </q-td>
        </template>
      </q-table>
    </div>
      ...
      <q-form @submit="submit" class="dialog_card column">
        ...
        <q-scroll-area class="col">
          <div class="row q-col-gutter-x-md dialog_form q-pa-md">
            ...
            <div class="col-12">
              <h5>目录编号：</h5>
              <catalogselect :form.sync="form" type="DemoTest" />
            </div>
          </div>
        </q-scroll-area>
  ...
  data() {
    return {
      ...
      url: {
        ...
        add: '/demo/test/add',
        edit: '/demo/test/edit',
        delete: '/demo/test/delete',
        deleteBatch: '/demo/test/deleteBatch',
        exportXlsUrl: '/demo/test/exportXls',
        importExcelUrl: '/demo/test/importExcel',
      },
    };
  },
  methods: {
