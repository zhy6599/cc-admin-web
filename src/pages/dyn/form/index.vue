        ...
        <template #body-cell-opt="props">
          <q-td :props="props" :auto-width="true">
            <q-btn
              ...
              type="a"
              target="_blank"
              :href="`#/dynamic?id=${props.row.id}`"
              color="primary"
              icon="mdi-image-edit-outline"
            >
              <q-tooltip>代码设计</q-tooltip>
            </q-btn>
            <q-btn flat round dense color="primary" icon="mdi-laptop" @click="view(props.row)">
      ...
      <q-form @submit="submit" class="dialog_card column">
        ...
        <q-scroll-area class="col">
          <div class="row q-col-gutter-x-md dialog_form q-pa-md">
            ...
            <div class="col-12">
              <h5>上级菜单：</h5>
              <catalogselect :form.sync="form" type="DynForm" />
            </div>
          </div>
        </q-scroll-area>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          name: 'catalogId_dictText', align: 'left', label: '上级菜单', field: 'catalogId_dictText',
        },
        {
      ...
      url: {
        ...
        edit: '/dyn/form/edit',
        copy: '/dyn/form/copy',
        queryById: '/dyn/form/queryById',
        delete: '/dyn/form/delete',
        deleteBatch: '/dyn/form/deleteBatch',
        exportXlsUrl: '/dyn/form/exportXls',
        importExcelUrl: '/dyn/form/importExcel',
      },
    };
  },
  methods: {
