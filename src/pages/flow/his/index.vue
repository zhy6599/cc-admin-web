      ...
      >
        ...
        <template #body-cell-opt="props">
          <q-td :props="props" :auto-width="true">
            ...
            <btn-del label="工作流历史" @confirm="del(props.row)" />
          </q-td>
        </template>
      </q-table>
    </div>
  ...
  data() {
    return {
      columns: [
        ...
        {
          name: 'action', align: 'left', label: '动作', field: 'action',
        },
        {
      ...
      url: {
        ...
        copy:
          '/flow/his/copy',
        delete: '/flow/his/delete',
        deleteBatch: '/flow/his/deleteBatch',
        exportXlsUrl: '/flow/his/exportXls',
        importExcelUrl: '/flow/his/importExcel',
      },
    };
  },
  methods: {
