  ...
  <q-page class="cc-admin">
    <div class="col bg-white shadow-2 q-pa-md q-ma-sm">
      ...
      >
        ...
        <template #body-cell-txtContent="props">
          <q-td :props="props">
            <div>{{ellipsis(props.row.txtContent,60)}}</div>
          </q-td>
        </template>
        <template #body-cell-opt="props">
          <q-td :props="props" :auto-width="true">
            ...
            <btn-del label="新闻信息" @confirm="del(props.row)" />
          </q-td>
        </template>
      </q-table>
    </div>
  ...
  data() {
    return {
      columns: [
        ...
        {
          name: 'txtContent', align: 'left', label: '详细内容', field: 'content',
        },
        {
