      ...
      >
        ...
        <template #body-cell-opt="props">
          <q-td :props="props" :auto-width="true">
            ...
            <btn-del label="工作流流程定义" @confirm="del(props.row)" />
          </q-td>
        </template>
      </q-table>
    </div>
      ...
      <q-form @submit="submit" class="dialog_card column">
        ...
        <q-scroll-area class="col">
          <div class="row q-col-gutter-x-md dialog_form q-pa-md">
            ...
            <div class="col-12">
              <h5>定义内容：</h5>
              <q-input outlined dense v-model="form.nodes" type="text" />
            </div>
          </div>
        </q-scroll-area>
  ...
  data() {
    return {
      columns: [
        ...
        {
          name: 'id', align: 'left', label: '流程名', field: 'id',
        },
        {
        ...
        {
          name: 'nodes', align: 'left', label: '定义内容', field: 'nodes',
        },
        {
      ...
      url: {
        ...
        copy:
          '/flow/def/copy',
        delete: '/flow/def/delete',
        deleteBatch: '/flow/def/deleteBatch',
        exportXlsUrl: '/flow/def/exportXls',
        importExcelUrl: '/flow/def/importExcel',
      },
    };
  },
  methods: {
