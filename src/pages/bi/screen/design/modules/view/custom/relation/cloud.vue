...
export default {
  ...
  methods: {
    ...
    getY(x) {
      const y = Math.sqrt((1 - (x / 38) ** 2) * (30 ** 2));
      return y;
    },
    getOutY(x) {
      const y = Math.sqrt((1 - ((x / 50) ** 2)) * (42 ** 2));
      return y;
    },
    makeOptions() {
      const items = [{
      ...
      },
      {
        ...
        symbol: '',
        name: '市气象局',
        value: [49.95, this.getOutY(49.95)],
        pointType: 'point',
        belong: '市电子政务中心',
        label: {
          show: true,
      ...
      },
      {
        ...
        symbol: '',
        name: '市商务局',
        value: [-49.99, this.getOutY(-49.99)],
        pointType: 'point',
        belong: '烟台道联通机房',
        label: {
          show: true,
